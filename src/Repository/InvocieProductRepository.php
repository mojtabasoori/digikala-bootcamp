 ...
 */
class InvocieProductRepository extends ServiceEntityRepository
{
...
//    /**
//     * @return InvocieProduct[] Returns an array of InvocieProduct objects
//     */
...
//    public function findOneBySomeField($value): ?InvocieProduct
//    {
//        return $this->createQueryBuilder('i')
//            ->andWhere('i.exampleField = :val')
//            ->setParameter('val', $value)
